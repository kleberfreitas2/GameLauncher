...
### 👉 [![Download GLauncher](https://img.shields.io/badge/⬇_DOWNLOAD_GLauncher_v2.9.3-3B82F6?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/kleberfreitas2/GameLauncher/releases/latest)

> Baixe o instalador `GLauncher_Setup_v2.9.3.exe` na release e siga as etapas de instalação.
>
