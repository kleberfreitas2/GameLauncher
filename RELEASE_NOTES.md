...
[![Download GLauncher v2.10.2](https://img.shields.io/badge/⬇_DOWNLOAD_v2.10.2-00E676?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/kleberfreitas2/GameLauncher/releases/latest)

> Baixe e execute o instalador `GLauncher_Setup_v2.10.2.exe`.
>
...
- README e release notes atualizados para `2.10.2`.
- Instalador atualizado para gerar `GLauncher_Setup_v2.10.2.exe`.
...
- 📝 README, manual e instalador sincronizados com a versão do projeto.
